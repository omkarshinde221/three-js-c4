...
context2.fillText("Transactions: { ", 13, 60);
context2.fillText("'sender:' ", 23, 80, );
context2.fillText(sender, 73, 80);
context2.fillText("'receiver:' ", 23, 100 );
context2.fillText(receiver, 73, 100);
context2.fillText("'amount:' ", 23, 120 );
context2.fillText(amount, 73, 120);
context2.fillText("} ", 13, 140);
